...
Also my cards have a QR link to my github page that has a link to this slideshow.
...
This presentation used to have a bunch more words - concepts, descriptions, types, and techniques, etc. But it took way too long!
...
<p></p>
<audio controls><source type="audio/mp3" src="audio/3-chords1.mp3"></audio>
<p></p>
<audio controls><source type="audio/mp3" src="audio/3-chords2.mp3"></audio>
