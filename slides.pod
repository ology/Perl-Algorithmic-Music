...
Then I will skip the deep dive into types and techniques of algorithmic music,
...
Generative music is not necessarily alorithmic. For instance, Eno's Music for Airports #2 is actually a physical tape-loop system.
...
Combinatorial patterns are "juxtaposed" making beats!
