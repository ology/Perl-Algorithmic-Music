...
Here we use filthy global variables! I'll be sad if you leave now though! Anyway,

1 Music programs are not "mission critical."

2 They are not "time-sensitive" either. The code just creates MIDI files, rather than real-time processing.
