...
This slide is a complete program that shows the score and synchronization.
...
Shameless plug: My latest album on youtube, spotify, apple music, etc., which includes the partially algorithmic tune, "Permutational" is:

L<https://ology.net/XI/> - Check it out!
