...
These slides show complete programs.
...
<audio controls><source type="audio/mp3" src="audio/code-1-otj.pl.mp3"></audio>
...
Shows Music::Scales and score settings.
...
sub bass {
    ...
    my @pitches = get_scale_MIDI('C', 2, 'pentatonic');  # Non-clashing scale octave
...
sub treble {
    ...
    my @pitches = (
        ...
        get_scale_MIDI('C', 5, 'major'),  # <- TWO OCTAVES
    );
    for my $n (1 .. 4) {
...
<audio controls><source type="audio/mp3" src="audio/code-2-random.pl.mp3"></audio>
...
sub chords {
    ...
    for my $named (qw(Cm7 F7 BbM7 EbM7 Adim7 D7 Gm)) {
        my @chord = $mcn->chord_with_octave($named, 4);  # Lowest note in octave 4
...
<audio controls><source type="audio/mp3" src="audio/code-3-chords.pl.mp3"></audio>
<p></p>
<audio controls><source type="audio/mp3" src="audio/code-3-chords2.pl.mp3"></audio>
