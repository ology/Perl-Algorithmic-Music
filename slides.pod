...
<p></p>
<audio controls><source type="audio/mp3" src="Eno-2_2.mp3"></audio> (<a href="http://en.wikipedia.org/wiki/Brian+Eno">Brian Eno</a>)
...
<audio controls><source type="audio/mp3" src="code-3-chords.mp3"></audio>
<p></p>
