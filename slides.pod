...
Song / audio I<analysis>

=item *

I<Real-time> audio / MIDI processing

=item *

I<Low-level> handling of MIDI events (e.g. note_on, note_off, sysex)
...
=head1 Why Do Algorithmic Music?

=over

=item *

Musical creation in and of itself!
...
To make and import fragments into a larger context, like a digital audio workstation ("DAW")
