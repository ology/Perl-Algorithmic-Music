...
Also, this used to have a bunch of concepts, descriptions, types, and techniques. But it took way too long! See the OLD/ directory, in the github repo.
...
The idea of phrase development itself is controversial. E.g. Brian Eno, Primus guitar solos.
...
> rm -f audio/2-random.mp3 ; timidity -c timidity.cfg -A10a \
  code/2-random.pl.mid -Ow -o - | ffmpeg -i - -acodec libmp3lame \
  -ab 64k audio/2-random.mp3
