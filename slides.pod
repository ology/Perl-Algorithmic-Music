...
The second will be examples of actual algorithms.
...
This slide just introduces the next one.

But here we instantiate our new chord to note list object first.
...
This Slideshow: L<https://github.com/ology/Perl-Algorithmic-Music>
...
Shameless plug: My L<latest album|https://ology.net/XI/> is on youtube, spotify, apple music, etc., and includes the partially algorithmic tune, "Permutational." Check it out!
