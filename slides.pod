...
Or probabality logic to determine the selection
...
"A motif is a brief melodic or rhythmic formula out of which longer passages are developed" - More later!

=back

=begin note

The concept of "development" is controversial. Some music doesn't develop phrases at all. Eno? Primus guitar solos?
...
my $score = setup_score(); # default volume, bpm, etc
